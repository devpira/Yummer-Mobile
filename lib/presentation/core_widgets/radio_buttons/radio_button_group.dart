...
enum RadioButtonGroupOrientation {
  HORIZONTAL,
  VERTICAL,
}
...
class RadioButtonGroup extends StatefulWidget {
  ...
  final RadioButtonGroupOrientation orientation;
  ...
  const RadioButtonGroup({
    ...
    this.orientation = RadioButtonGroupOrientation.VERTICAL,
    this.itemBuilder,
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < widget.labels.length; i++) {
      ...
      if (widget.itemBuilder != null) {
        ...
        if (widget.orientation == RadioButtonGroupOrientation.VERTICAL) {
          content.add(InkWell(
    ...
    return Container(
      ...
      child: widget.orientation == RadioButtonGroupOrientation.VERTICAL
